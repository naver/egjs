# How to contribute to egjs-persist
egjs-persist is opened to everyone and we're welcoming for any kind of contribution.
We believe that our project can grow with your interests helping others' necessities.

## Style Guide

egjs-persist has several style guidelines to follow.
...
egjs-persist use commit logs in many different purposes (like creating CHANGELOG, ease history searching, etc.).
...
1. Fork `egjs-persist` on your repository
...
9. Create a new PR from your branch to egjs-persist.
10. Wait for reviews.
...
## License
By contributing to egjs-persist, you're agreeing that your contributions will be licensed under its [MIT](https://opensource.org/licenses/MIT) license.